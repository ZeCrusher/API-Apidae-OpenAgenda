				...
				<pre><code class="language-nof">
{
  "query" : {
    ...
    "order" : "IDENTIFIANT",
    "asc" : true,
    "responseFields" : [ "id","nom","localisation", "descriptionTarif",
										"presentation",
										"prestations", 
										"illustrations",
										"aspects",
...
<p><h2 id="config">* Création du fichier config.php </h2> </p>

<p><b><i>Formulaire en version bêta</i></b> - (fichier de démo)</p>
 
<p>Le formulaire va créer un fichier config.php avec un nom différent pour ne pas écraser le fichier d'origine (config.php.<b>txt</b>). Ce formulaire permet de créer votre fichier de configuration <b><i>sans coder</i></b>.</p>
<p><b>Liste des clefs du fichier d'origine /config/config.php </b> : </p>
<?php
	...
	while ($line = fgets($txt_file))	 
	{
			...
			if ($pos[0] !== false) {	
				...
				echo '<input type="text" value="'.$keypublic.'" class="form-control input-sm validate[required]"  name="keypublic" id= "keypublic" placeholder="Votre clef public..." ><br>';
			}
			...
			if ($pos[1] !== false) {	
				...
				echo '<input type="text" value="'.$keysecret.'"  class="form-control input-sm validate[required]" name="keysecret" id= "keysecret" placeholder="Votre clef Secrète..." ><br>';
			...
			if ($pos[2] !== false) {	
				...
				echo '<input type="text" value="'.$agendaUid.'" class="form-control input-sm validate[required]" name="agendaUid" id= "agendaUid" placeholder="Votre AgendaUid ..." ><br>';
			...
			if ($pos[2] !== false) {	
				...
				echo '<input type="text" value="'.$territoireIds.'" class="form-control input-sm validate[required]" name="territoireIds" id= "territoireIds" placeholder="Votre TerritoireIds..." ><br>';
			...
			if ($pos[3] !== false) {	
				...
				echo '<input type="text" value="'.$selectionIds.'" class="form-control input-sm validate[required]" name="selectionIds" id= "selectionIds" placeholder="Votre SelectionIds..." ><br>';
			...
			if ($pos[4] !== false) {	
				...
				echo '<input type="text" value="'.$apiKey.'" class="form-control input-sm validate[required]" name="apiKey" id= "apiKey" placeholder="Votre ApiKey..." ><br>';
			...
			if ($pos[5] !== false) {	
				...
				echo '<input type="text" value="'.$projetId.'" class="form-control input-sm validate[required]" name="projetId" id= "projetId" placeholder="Votre ProjetId..." ><br>';
	...
	fclose($txt_file);									
		...
		if ($fichier_config_maj=="OK") echo '<br><br><br> Votre fichier a été enregistré [<a href="config/config.php.txt" target="_blanck">config/config.php.txt</a>]';
					...
					<div class="col-lg-8 order-last order-lg-first">
						<ul class="list-inline">
							<li class="list-inline-item">
								<a href="www.martigues-tourisme.com">martigues-tourisme.com</a> | 2022 
							</li>
						</ul>
					</div>
